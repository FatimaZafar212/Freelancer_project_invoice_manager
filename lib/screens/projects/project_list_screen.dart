...
class ProjectListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: dummyProjects.isEmpty
          ? const EmptyStateView(
              message: "You haven't accepted any projects yet.",
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                switch (project.status) {
                  case 'Completed': statusColor = const Color(0xFF03DAC6); break;
                  case 'In Progress': statusColor = primaryColor; break;
                  default: statusColor = secondaryColor; break;
                }
